...
function ecommerce_landing_page_customize_register( $wp_customize ) {
	...
	$wp_customize->add_panel( 'ecommerce_landing_page_panel_id', array(
		...
		'theme_supports' => '',
		'title' => esc_html__( 'VW Settings', 'ecommerce-landing-page' ),
		'priority' => 10,
	));
  ...
  //Woocommerce settings
	...
	//Selective Refresh
	$wp_customize->selective_refresh->add_partial( 'ecommerce_landing_page_woocommerce_shop_page_sidebar', array( 'selector' => '.post-type-archive-product #sidebar',
		'render_callback' => 'ecommerce_landing_page_customize_partial_ecommerce_landing_page_woocommerce_shop_page_sidebar', ) );
